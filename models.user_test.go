...
func TestValidUserRegistration(t *testing.T) {
	...
	u, err := registerNewUser("newuser", "newpass", "newname")
...
func TestInvalidUserRegistration(t *testing.T) {
	...
	u, err := registerNewUser("user1", "pass1", "Sean")
	...
	u, err = registerNewUser("newuser", "", "newname")

	if err == nil || u != nil {
		t.Fail()
	}

	// Try to register with a blank name
	u, err = registerNewUser("anotheruser", "newpass", "")
...
func TestUsernameAvailability(t *testing.T) {
	...
	// Register a new user
	registerNewUser("newuser", "newpass", "newname")
